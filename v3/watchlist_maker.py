...
sr_filter = []
# for pair in df_pairs['Currency']:
#     if 0.81 >= df_pairs['% Away Upper'][df_pairs['Currency'] == pair].values[0] >= 0.65:
#         sr_filter.append('BUY')
#     elif 0.21 >= df_pairs['% Away Upper'][df_pairs['Currency'] == pair].values[0] >= 0.4:
#         sr_filter.append('SELL WATCHLIST')
#     elif 0.80 >= df_pairs['% Away Upper'][df_pairs['Currency'] == pair].values[0] >= 1:
#         sr_filter.append('BUY WATCHLIST')
#     elif 0.81 >= df_pairs['% Away Lower'][df_pairs['Currency'] == pair].values[0] >= 0.65:
#         sr_filter.append('SELL')
#     elif 0.21 >= df_pairs['% Away Lower'][df_pairs['Currency'] == pair].values[0] >= 0.40:
#         sr_filter.append('BUY WATCHLIST')
#     elif 0.80 >= df_pairs['% Away Lower'][df_pairs['Currency'] == pair].values[0] >= 1:
#         sr_filter.append('SELL WATCHLIST')
#     else:
