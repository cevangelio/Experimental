...
log = Logger()
log.configure(logfile='D:/bt_ma_cross_strategy.log')
...
ok = MT_Back.Set_data_directory(data_directory='D:\TradeJournal\Data\data_sync\EURUSD_M1')
if (ok == False):
    print('Error in setting data directory')
