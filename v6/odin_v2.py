...
v2 - follow trend but price is reversed of previous low/high
...
MT = Pytrader_API()
ports = [1122, 1125, 1127, 1129, 1131, 1133]
port_dict = {1122:'FTMO_Live', 1125:'FXCM_Demo', 1127:'GP_Live', 1129:'GP_Demo', 1131:'FTMO_Demo', 1133:'FTMO_DEMO_2'}
...
con = MT.Connect(server='127.0.0.1', port=1133, instrument_lookup=symbols)
...
if datetime.now().hour >= 19:
    ...
    if morning < 0:
        ...
        trade_odin(port = 1133, vol = round(fxcm_demo, 2))
        ...
        # trade_odin(port = 1122, vol = ftmo_vol, rev='FT')
        trade_odin(port = 1133, vol = fxcm_demo)
